...
/* Modify the following definitions to fit your wireless and enrollment credentials. */
  ...
  #define device_version 80 // Change to the ChromeOS version you expect to use with Centipede; Changes have been reported in the following ranges 58-68, 69, 70
...
#define selected_on_boot 0 //[0,1,2,3]  Active location when device poweron : 3 - "Let's go", 2 - accessibility, 1 - language (Default), 0 - menu 
...
void wifiConfig() {
  ...
  wait(5);
  repeatKey(KEY_TAB, 1 + VERSION_70); // 3 for version 70+ (black menu)****wifi is highlighted so changed to 1 if wifi is setup needs to be 2
